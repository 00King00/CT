...
$('.add-to-fav').click(function(){
	...
	var recommend_slider=$('#recommend-slider').lightSlider({
		...
		$("#recommend-slider-controls .ls-prevSlide").click(function(){
			recommend_slider.goToPrevSlide();
		});
		$("#recommend-slider-controls .ls-nextSlide").click(function(){
	...
	var news_slider=$('#news-slider').lightSlider({
		...
		$("#news-slider-controls .ls-prevSlide").click(function(){
			news_slider.goToPrevSlide();
		});
		$("#news-slider-controls .ls-nextSlide").click(function(){
